...
--
-- Table structure for table `joined_contest`
--

CREATE TABLE `joined_contest` (
  `id` int(11) NOT NULL,
...
INSERT INTO `squad` (`id`, `info`, `player`, `team`, `credits`, `post_id`) VALUES
(1, 'batsman', 'virat kohli', 'india', 10, 0),
(2, 'batsman', 'rohit sharma', 'india', 10, 0),
(3, 'batsman', 'shikhar dhawan', 'india', 9, 0),
(4, 'wicketkeeper', 'm s dhoni', 'india', 9, 0),
(5, 'bowler', 'jasprit bumrah', 'india', 9.5, 0),
(6, 'bowler', 'bhuvaneshwar kumar', 'india', 9.5, 0),
(7, 'bowler', 'yujvendra chahal', 'india', 9, 0),
(8, 'all rounder', 'hardik pandya', 'india', 9, 0);
...
--
-- Indexes for table `joined_contest`
--
ALTER TABLE `joined_contest`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `joined_contest`
--
ALTER TABLE `joined_contest`
